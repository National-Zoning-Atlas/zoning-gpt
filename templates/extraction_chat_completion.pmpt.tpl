...
# Schema
{
    "extracted_text": list[str], // The verbatim text from which the result was extracted. Make sure to escape newlines, and ONLY USE VALUES EXTRACTED DIRECTLY FROM THE TEXT.
