...
input_hf_dataset_path = DATA_ROOT / "tx_hf_dataset"
output_hf_dataset_name = "xyzNLP/nza-tx-zoning-codes-text"
output_hf_dataset_path = DATA_ROOT / "tx_hf_text_dataset"
