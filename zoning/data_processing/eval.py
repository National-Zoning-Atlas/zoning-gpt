...
def compute_eval_result(town: str, district_name: str, term: str, row):
    ...
    for result in outputs:
        ...
        yield {
            ...
            "correct_page_searched": any(gt_page & searched_pages),
...
def main():
    ...
    num_correct_page_searched = len(results_df.query("correct_page_searched"))
    ...
    with EVAL_METRICS_PATH.open("w", encoding="utf-8") as f:
        yaml.dump({
            ...
            "page_search_recall": num_correct_page_searched / num_results,
